...
// This function with name "pictureSlider4" change the picture in slider if the buttons are clicked.
function pictureSlider4(number) {
    ...
    image.src = "images/fourthmodel/car4." + imagecount + ".png";
}