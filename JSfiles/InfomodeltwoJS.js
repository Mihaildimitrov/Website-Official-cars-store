...
// This function with name "pictureSlider2" change the picture in slider if the buttons are clicked.
function pictureSlider2(number) {
    ...
    image.src = "images/secondmodel/car2." + imagecount + ".png";
}